...
- Turning on the checkbox next to a profile's name in the list on the left makes that profile launch automatically whenever the app starts. Turning on "Start at login" at the bottom of the sidebar makes the app itself launch into the system tray automatically when you log in.
